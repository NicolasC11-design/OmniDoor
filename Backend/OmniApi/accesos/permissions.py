...
class IsAdmin(permissions.BasePermission):
    def has_permission(self, request, view):
        return request.user.is_authenticated and request.user.rol in ['admin', 'administrador']
class IsSeguridadOrAdmin(permissions.BasePermission):
    ...
    """
    def has_permission(self, request, view):
        return request.user.is_authenticated and (request.user.rol == 'seguridad' or request.user.rol in ['admin', 'administrador'])